    ...
    <main className="flex min-h-screen flex-col p-6">
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-300 px-6 py-10 md:w-2/5 md:px-20">
          ...
          <Link
            href="/login"
            className="flex items-center gap-5 self-start rounded-lg bg-slate-950 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-gray-500 md:text-base"
          >
